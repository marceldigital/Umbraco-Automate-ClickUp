...
export type ClientOptions = {
    baseUrl: 'https://localhost:44369/' | (string & {});
};
...
export type GetPingData = {
    ...
    path?: never;
    query?: never;
    url: '/umbraco/automateclickup/api/v1/ping';
};
...
export type GetWhatsMyNameData = {
    ...
    path?: never;
    query?: never;
    url: '/umbraco/automateclickup/api/v1/whatsMyName';
};
...
export type GetWhatsTheTimeMrWolfData = {
    ...
    path?: never;
    query?: never;
    url: '/umbraco/automateclickup/api/v1/whatsTheTimeMrWolf';
};
...
export type GetWhoAmIData = {
    ...
    path?: never;
    query?: never;
    url: '/umbraco/automateclickup/api/v1/whoAmI';
};
